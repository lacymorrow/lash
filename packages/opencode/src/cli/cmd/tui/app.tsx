...
import { createSignal, createEffect, onCleanup, Switch, Match, ErrorBoundary, resetErrorBoundaries, createMemo, onMount, batch, on, untrack } from "solid-js"
...
import { ShellState as Shell } from "@/shell/shell"
...
function App() {
  ...
  const sessionExists = createMemo(() => {
    ...
    return !!sync.session.get((route.data as SessionRoute).sessionID)
  })
